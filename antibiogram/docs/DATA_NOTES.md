...
- `วันที่ลงทะเบียน` มีแต่วันที่ (ไม่มีเวลา) -> การคำนวณ 48 ชม. จะเทียบ specimen datetime กับ
  admit ที่ตั้งเป็นต้นวัน (00:00) เว้นแต่ QR-10-020 มีคอลัมน์เวลา admit เพิ่ม (ต้องดูไฟล์จริง)
